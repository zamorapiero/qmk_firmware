...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, LSFT_T(KC_SLSH), KC_UP, MO(2),
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, MO(1), KC_SPC, KC_SPC, KC_MEDIA_PLAY_PAUSE, KC_DELETE, KC_LEFT, KC_DOWN, KC_RGHT
